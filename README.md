...
Laboratory work | № experiment | Spoon | Paintbrush | Smiley face | Wheel | Bush | Micro avg | Macro avg | Weighted avg | Accuracy | Cross entropy | Time
  |             (f1-score)|(f1-score)|(f1-score)|(f1-score)|(f1-score)|(f1-score)|(f1-score) |(f1-score) |(f1-score)    | (%)      |               | (min)
--|---|----------|---------------|-------------|-----------|-----------|-----------|-----------|--------------|-----------|---------------|-----------|
2 | 3 |   0.95   |      0.94     |    0.92     |    0.96   |    0.84   |   0.92    |   0.92    |    0.93      |     98    |      0.1      |    77min  |
3 | 3 |   0.96   |      0.95     |    0.96     |    0.97   |    0.92   |   0.95    |   0.95    |    0.95      |     95    |      0.18     |   105min  |
4 | 0 |   0.97   |      0.95     |    0.95     |    0.98   |    0.94   |   0.96    |   0.97    |     0.97     |     97    |      0.18     |   107min  |
5 | 2 |     0    |        0      |      0      |     0     |      0    |     0     |     0     |      0       |     96    |      0.1      |    33min  |
