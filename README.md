...
- Лабораторная работа №2
 Hidden neurons            | Accuracy | Cross entropy | Time 
---------------------------|----------|---------------|-----------
 *                         | *        | *             | *
 [3*28*28, 2*28*28, 14*28] | 0.96     | 0.14          | 1h 13min 
 [2*28*28, 14*28]          | 0.98     | 0.1           | 1h 17min
 
- Лабораторная работа №3
 Block count | Convolution layers | Batch normalization | Accuracy | Cross entropy | Time 
-------------|--------------------|---------------------|----------|---------------|---------
 3           | 2                  | -                   | 0.95     | 0.2           | 1h 15min 
 4           | 2                  | -                   | 0.35     | 1.37          | 1h 05min
 3           | 3                  | +                   | 0.95     | 0.18          | 1h 45min

- Лабораторная работа №4
 Neurons            | Accuracy | Cross entropy | Time 
--------------------|----------|---------------|-----------
 *                  | *        | *             | *

- Лабораторная работа №5
 Type          | Accuracy | Cross entropy | Time 
---------------|----------|---------------|-----------
 *             | *        | *             | *
